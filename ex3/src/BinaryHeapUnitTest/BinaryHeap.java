...
/* Generic Piority Queue, implemented as a Min Heap
 */
 ...
 *
 * @author Andrea Malgaroli, Lorenzo Tabasso
 */
public class BinaryHeap<T extends Comparable<T>>
{
    ...
    /*
     * Constructor - takes an array of type T
     * @param array T[] array
     */
    ...
    /*
     * Removes min item from heap (the root)
     * <p>re-heapifies
     * @return value of T that  minimum value in heap
     */
    public T remove()
    {
        T result = peek();
    ...
    /*
     * Removes min item from heap
     * same as <code>remove()</code> but does not throw exception on empty
     * <p>re-heapifies
     * @return value of T that is minimum value in heap;  or <code>null</code> if empty
     */
    public T poll()
    {
    ...
    /*
     * returns min value without removing it
     * @return value type T
