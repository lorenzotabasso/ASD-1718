...
// the right index of the array, and a pointer fo a compare function.
...
// array_to_test, the size of array_of_sums, the
// left index of the array, a pointer to a compare function and a pointer
// to a function called sums_support, which sums two numbers pointed
// by two void pointers (used for compare purpose).
